        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <div className="flex items-center gap-2 bg-base-200 px-4 py-2 rounded-full">
              <span className="text-2xl">JupyterLite</span>
            </div>
            <div className="flex items-center gap-2 bg-base-200 px-4 py-2 rounded-full">
              <span className="text-2xl">Python in Browser</span>
            </div>
            <div className="flex items-center gap-2 bg-base-200 px-4 py-2 rounded-full">
              <span className="text-2xl">Mermaid Diagrams</span>
            </div>
            <div className="flex items-center gap-2 bg-base-200 px-4 py-2 rounded-full">
              <span className="text-2xl">Exercises</span>
            </div>
            <div className="flex items-center gap-2 bg-base-200 px-4 py-2 rounded-full">
              <span className="text-2xl">PDF Export</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                <div className="text-4xl mb-4">Executable Code</div>
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                <div className="text-4xl mb-4">Interactive Widgets</div>
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                <div className="text-4xl mb-4">Exercises & Solutions</div>
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                <div className="text-4xl mb-4">Math & Diagrams</div>
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                <div className="text-4xl mb-4">Cross-References</div>
            ...
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                <div className="text-4xl mb-4">One-Click Deploy</div>
